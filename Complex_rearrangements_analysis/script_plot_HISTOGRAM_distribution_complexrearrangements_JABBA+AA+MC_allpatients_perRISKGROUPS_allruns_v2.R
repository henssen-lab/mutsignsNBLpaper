...
for (i in 2:(dim(MATRIX_complex_svs_M_FREQ)[2]-1)){
  ...
  total.exp.perrisk[1,i] <- exp_MNA*100/dim(MATRIX_complex_svs_M_FREQ[MATRIX_complex_svs_M_FREQ$risk_group=="HR_MNA",])[1]
  total.exp.perrisk[2,i] <- exp_HR*100/dim(MATRIX_complex_svs_M_FREQ[MATRIX_complex_svs_M_FREQ$risk_group=="HR_non_MNA",])[1]
  total.exp.perrisk[3,i] <- exp_no*100/dim(MATRIX_complex_svs_M_FREQ[MATRIX_complex_svs_M_FREQ$risk_group=="non_HR",])[1]
}
